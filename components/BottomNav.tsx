...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#303030] border-t border-[#E5E6E6] dark:border-[#3D3D3D] pb-safe z-40 md:relative md:border-t-0 md:bg-transparent md:dark:bg-transparent md:max-w-2xl md:mx-auto mt-4 transition-colors">
      <div className="flex justify-around items-center h-16 md:bg-white md:dark:bg-[#303030] md:rounded-xl md:shadow-sm md:border md:border-[#E5E6E6] md:dark:border-[#3D3D3D] px-4 transition-colors">
        <Link 
          href="/" 

...
export default function AchievementToast() {
  ...
  return (
    <div className="fixed top-4 left-4 right-4 z-[100] pointer-events-none flex justify-center">
      <div className="bg-white dark:bg-[#1A1A1E] border-2 border-yellow-400 rounded-2xl shadow-2xl p-4 flex items-center gap-4 animate-in slide-in-from-top-10 fade-in duration-500 max-w-sm w-full">

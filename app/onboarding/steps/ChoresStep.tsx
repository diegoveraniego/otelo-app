...
const CHORE_TEMPLATES: ChoreTemplate[] = [
  ...
  { name: 'Barrer cocina', emoji: '🧹', category: 'Cocina', threshold_days: 1 },
  { name: 'Limpiar cocina', emoji: '🧼', category: 'Cocina', threshold_days: 3 },
  { name: 'Limpiar el refrigerador', emoji: '🧊', category: 'Cocina', threshold_days: 30 },
  { name: 'Organizar la despensa', emoji: '🥫', category: 'Cocina', threshold_days: 15 },
  ...
  { name: 'Limpiar Living', emoji: '🧹', category: 'Limpieza', threshold_days: 7, points: 10 },
  ...
  { name: 'Limpiar patio', emoji: '🍂', category: 'Jardín', threshold_days: 7 },
  { name: 'Regar plantas', emoji: '🪴', category: 'Jardín', threshold_days: 2 },
  { name: 'Barrer la vereda / entrada', emoji: '🧹', category: 'Jardín', threshold_days: 7 },

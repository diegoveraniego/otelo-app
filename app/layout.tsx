  ...
  return (
    <html lang="es" suppressHydrationWarning className={`${chelseaMarket.variable} w-screen overflow-x-hidden`}>
      ...
      <body
        ...
        className={`${inter.className} bg-[#FAFAFA] dark:bg-[#101013] text-[#1E1E1E] dark:text-white pb-[4rem] min-h-screen transition-colors`}
      >
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <header
            className="sticky top-0 z-40 bg-white dark:bg-[#101013] border-b border-[#E5E6E6] dark:border-[#2C2C30] px-2 py-1 md:px-4 md:py-3 flex justify-between items-center w-screen transition-colors"
          >
